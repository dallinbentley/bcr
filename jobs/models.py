...
class JobType(models.Model):
    job_type_description = models.CharField(20)
...
class Skill(models.Model):
    skill_description = models.CharField(20)
...
class JobListing(models.Model):
    ...
    job_title = models.CharField(50)
    wage = models.FloatField(blank=True, null=True)
    salary = models.FloatField(blank=True, null=True)
    job_type = models.ForeignKey(JobType, on_delete=CASCADE)
    job_description = models.CharField(2000)
    preferred_skill1 = models.ForeignKey(Skill, on_delete=models.DO_NOTHING, blank=True, null=True)
    preferred_skill2 = models.ForeignKey(Skill, on_delete=models.DO_NOTHING, blank=True, null=True)
    preferred_skill3 = models.ForeignKey(Skill, on_delete=models.DO_NOTHING, blank=True, null=True)
