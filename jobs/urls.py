...
from .views import myListingPageView, similarApplicantsRecommender, searchsimilarjobs
...
urlpatterns = [
    ...
    path('update-listing-view/<int:employerID>/<int:listingID>', updateJobListingPageView, name='updatelistingpage'),
    path('update-lisitng/<int:listingID>/<int:employerID>', updateJobListing, name='updatelisting'),
    ...
    path('delete/<int:employerID>/<int:jobID>/', deleteJobListing, name='deletejob'),
    ...
    path('searchsimilar/<int:applicantID>/<str:jobtitle>/', searchsimilarjobs, name='searchsimilar'),
]
